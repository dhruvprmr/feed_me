...
public class Fragment_Nearby_Volunteers_NGO extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__nearby__volunteers__n_g_o, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        app_bar_text.setText("Nearby Volunteer");
        ...
        recyclerView = view.findViewById(R.id.recycler_view_near_volunteer);
    ...
    private void readVolunteer() {
        ...
        Query query = ref.orderByChild("Type").equalTo("Volunteer");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userList.isEmpty()){
                    Toast.makeText(getContext(), "Volunteer are not available at the moment", Toast.LENGTH_SHORT).show();
                    simpleArcDialog.dismiss();
                }
            }
