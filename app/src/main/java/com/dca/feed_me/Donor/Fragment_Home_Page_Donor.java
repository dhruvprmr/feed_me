...
public class Fragment_Home_Page_Donor extends Fragment {
...
SimpleArcDialog simpleArcDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__home__page__donor, container, false);
    }
    ...
    private void readNGO() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userList.isEmpty()){
                    Toast.makeText(getContext(), "NGO's are not available at the moment", Toast.LENGTH_SHORT).show();
                    simpleArcDialog.dismiss();
                }
            }
