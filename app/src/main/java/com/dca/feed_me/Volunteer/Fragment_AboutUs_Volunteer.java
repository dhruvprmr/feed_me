...
public class Fragment_AboutUs_Volunteer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__about_us__volunteer, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        back_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(Fragment_AboutUs_Volunteer.this).navigate(R.id.fragment_Settings_Volunteer);
            }
        });
