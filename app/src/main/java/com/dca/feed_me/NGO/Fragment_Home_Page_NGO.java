...
public class Fragment_Home_Page_NGO extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__home__page__n_g_o, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycler_view_ngo);
    ...
    private void readNGO() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userList.isEmpty()){
                    Toast.makeText(getContext(), "Donors are not available at the moment", Toast.LENGTH_SHORT).show();
                    simpleArcDialog.dismiss();
                }
            }
